...
PS1="\n\[\e[32;1m\]┌─(\[\e[37;1m\]\u\[\e[32;1m\])──(\[\e[34;1m\]\$(ipaddr1)\[\e[32;1m\])──(\[\e[37;1m\]\$(git-branch-name)\[\e[32;1m\] Tracks \[\e[34;1m\]\$(branch-tracks)\[\e[32;1m\])──(\[\e[37;1m\]\$(gittotalstash)\[\e[32;1m\])──(\[\e[34;1m\]\@ \d\[\e[32;1m\])  \n├──(\[\e[37;0m\]\w\[\e[32;1m\])──(\[\e[34;1m\]\$(/bin/ls -1 | /usr/bin/wc -l | /bin/sed 's: ::g') files, \$(/bin/ls -lah | /bin/grep -m 1 total | /bin/sed 's/total //')b\[\e[30;1m\]\[\e[32;1m\])\n\[\e[32;1m\]└──⪼  \[\e[0m\]"
