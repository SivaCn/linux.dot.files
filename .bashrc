...
# PS1="\n\[\e[35;1m\]{\[\e[35;0m\]IP: \[\e[37;1m\]\$(ip)\[\e[35;1m\]}--->  {\[\e[35;0m\]Git Branch: \[\e[37;1m\]\$(git-branch-name)\$(git-dirty)\$(git-unpushed)\[\e[35;1m\], \[\e[35;0m\]Stashes: \[\e[37;1m\]\$(gittotalstash)\[\e[35;1m\]} \n{\[\e[35;0m\]PWD: \[\e[37;1m\]\w\[\e[35;1m\]}\n-->  \[\e[0m\]"
PS1="\n\[\033[0;37m\]\342\224\214\342\224\200\$([[ \$? != 0 ]] && echo \"[\[\033[0;31m\]\342\234\227\[\033[0;37m\]]\342\224\200\")[$(if [[ ${EUID} == 0 ]]; then echo '\[\033[0;31m\]'; else echo '\[\033[1;33m\]$(git-branch-name)\[\033[0;37m\]: \[\033[1;33m\]$(gittotalstash)\[\033[0;37m\]'; fi)\[\033[0;37m\]]\342\224\200[\[\033[0;32m\]\w\[\033[0;37m\]]\n\[\033[0;37m\]\342\224\224\342\224\200\342\224\200\342\225\274| \[\033[0m\]"
