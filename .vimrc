" vim-bootstrap 2022-10-06 07:19:23
...
" set the cursor line highlights
set cursorline
set cursorcolumn
...
nnoremap <silent> <F3> :NERDTreeToggle<CR>a
...
augroup vimrc-python
  ...
  autocmd FileType python setlocal expandtab shiftwidth=4 tabstop=8 colorcolumn=119
      ...
      \ foldmethod=indent foldnestmax=100 nofoldenable
augroup END
...
" open the definitions in new tab, if the definitions are in other files
